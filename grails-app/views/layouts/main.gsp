...
<nav class="navbar navbar-expand-lg navbar-dark navbar-static-top" role="navigation">
    <a class="navbar-brand" href="/#"><asset:image style="width: 50px; height: 50px;"
                                                   src="mane_logo_g.png" alt="Grails Logo"/></a>
...
%{--<asset:image src="../../assets/images/mane_logo_g.png" alt="Grails Guides" class="float-left"/>--}%
%{--</a>--}%
